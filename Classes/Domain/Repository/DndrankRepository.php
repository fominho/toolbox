 ...
 */
class DndrankRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
     ...
     * @return
     */
    public function findDndrank($currentUid)
    {
        $query = $this->createQuery();
        $row = $query->matching($query->equals('parentid', $currentUid))->execute();
        return $row;
    }
