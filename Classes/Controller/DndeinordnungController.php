 ...
 */
class DndeinordnungController extends \TYPO3\LtubeToolbox\Controller\AbstractToolboxController
{
     ...
     * @inject
     */
    protected $dndeinordnungRepository = null;
    
    /**
     * @var \TYPO3\LtubeToolbox\Domain\Repository\DndeinordngfeedbackRepository
     * @inject
     */
    protected $dndeinordngfeedbackRepository = null;
