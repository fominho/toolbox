...
/**
 * Test case for class \TYPO3\LtubeToolbox\Domain\Model\Hangmanquestion.
 *
 ...
 */
class HangmanquestionTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \TYPO3\LtubeToolbox\Domain\Model\Hangmanquestion
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \TYPO3\LtubeToolbox\Domain\Model\Hangmanquestion();
	}
	 ...
	 * @test
	 */
	public function getAmountOfTryReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getAmountOfTry()
		);
	}
	 ...
	 * @test
	 */
	public function setAmountOfTryForStringSetsAmountOfTry()
	{
		$this->subject->setAmountOfTry('Conceived at T3CON10');
