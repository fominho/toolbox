...
/**
 * Test case for class \TYPO3\LtubeToolbox\Domain\Model\Hangmananswer.
 *
 ...
 */
class HangmananswerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \TYPO3\LtubeToolbox\Domain\Model\Hangmananswer
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \TYPO3\LtubeToolbox\Domain\Model\Hangmananswer();
	}
